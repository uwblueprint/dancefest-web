    ...
    return (
      <React.Fragment>
        ...
        <div className={classes.settings_wrapper}>
          ...
          <DialogInput autoFocus={true} label="Enter an Option" name="option" value={value} onChange={this.handleOptionChange} fullWidth style={{ backgroundColor: 'rgb(255, 209, 217)' }} />
